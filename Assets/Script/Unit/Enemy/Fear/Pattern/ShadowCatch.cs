...
public class ShadowCatch : PatternDefault
{
    ...
    public override void Setting()
    {
        if (playerShadow == null) { 
            ...
            playerShadow = new GameObject();
            playerShadow.AddComponent<SpriteRenderer>();
            playerShadow.GetComponent<SpriteRenderer>().drawMode = SpriteDrawMode.Sliced;
            playerShadow.transform.localScale = Vector3.one;
    ...
    void Update()
    {
        ...
        if (IsRun) {
            ...
            else if (timer < PreDelay + TargettingTime)
            {
                ...
                esperExplosion=EffectPoolingController.EffectObjectController.GetExplosion();
